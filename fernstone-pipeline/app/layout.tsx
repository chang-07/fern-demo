  ...
  return (
    <html lang="en" suppressHydrationWarning className="min-h-screen">
      <body className={`${inter.variable} ${playfair.variable} font-sans bg-background text-foreground antialiased min-h-screen`}>
        ...
        >
          <div className="absolute inset-0 z-[-1] bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0MCIgaGVpZ2h0PSI0MCI+PGNpcmNsZSBjeD0iMjAiIGN5PSIyMCIgcj0iMSIgZmlsbD0icmdiYSgyNTUsIDI1NSwgMjU1LCAwLjA3KSIvPjwvc3ZnPg==')] dark:opacity-100 opacity-20 pointer-events-none mix-blend-difference" />
          {children}
          <Toaster />
        </ThemeProvider>
      </body>
