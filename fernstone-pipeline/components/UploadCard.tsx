            ...
            <CardContent className="space-y-6">
                ...
                {uploading ? (
                    <div className="space-y-4 pt-4 border-t border-slate-800/50">
                        ...
                        <p className="text-xs text-slate-500 text-center animate-pulse">Extracting coverage limits and checking compliance</p>
                    </div>
                ) : (
                    <Button
                        onClick={handleUpload}
                        disabled={!file}
                        className="w-full h-12 bg-emerald-600 hover:bg-emerald-700 text-white font-medium text-lg shadow-lg shadow-emerald-900/20"
                    >
